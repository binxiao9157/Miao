...
export const ACTION_PROMPTS: Record<'v1_approach' | 'v2_wait' | 'v3_return' | 'v4_fetch', VideoActionPrompt> = {
  ...
  v4_fetch: {
    prompt: "第一人称固定视角，明确空间纵深感，竖屏 9:16，480P，7 秒无音频，超写实风格，自然光影，种子值 12345。镜头起始轻微俯视，0-1.5 秒人类手从镜头底端伸入，握毛线球用力向前抛出，毛球沿符合物理规律的抛物线轨迹滚向远处猫窝，并停在猫窝右侧不远处；毛球抛出后，镜头平滑抬升至平视，固定展现房间纵深。1.5-3 秒猫咪从近景迅速跑向猫窝，精准叼起毛球，嘴巴细节真实无拟人化。3-5 秒猫咪转身跳上猫窝，放下毛球。5-7 秒猫咪缓慢调整姿态，全程猫咪完整身体在画面内，无裁切、无畸变、无错位。",
    duration: 7
  }
};
